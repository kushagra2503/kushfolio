...
export const InfoTipNav: React.FC<InfoTipNavProps> = ({ text, children }) => { //react.fc is used to define a functional component with props
  // This component displays a tooltip when hovering over the children elements.
  return (
